...
class BoardThemesColors {
  ...
  static const classic = BoardThemesColors(
    lightSquare: Color(0xFFF0D9B5),
    darkSquare: Color(0xFFB58863),
  );
  static const wood = BoardThemesColors(
    lightSquare: Color(0xFFDEB887),
    darkSquare: Color(0xFF8B4513),
    border: Color(0xFF3E2723),
  );
  static const blue = BoardThemesColors(
    lightSquare: Color(0xFFDEE3E6),
    darkSquare: Color(0xFF8CA2AD),
    border: Color(0xFF546E7A),
  );
  static const green = BoardThemesColors(
    lightSquare: Color(0xFFEEEED2),
    darkSquare: Color(0xFF769656),
    border: Color(0xFF4E7837),
  );
  static const gray = BoardThemesColors(
    lightSquare: Color(0xFFE0E0E0),
